...
PLATFORMS = {
    "whatsapp": ["whatsapp", "watsap", "whsatapp", "whasap", "wahtsapp", "whtsapp", "wapp", "wahtsap", "wtsap", "whstapp", "whtsp", "wa"],
    "instagram": ["instagram", "insta", "instgrm", "instgram", "ig", "instrm"],
    "facebook": ["facebook", "fb", "fcbk", "facebok", "facebk"],
    "linkedin": ["linkedin", "linkdin", "linkdn", "li"],
    "x": ["x", "twitter", "x.com", "tweet"]
}

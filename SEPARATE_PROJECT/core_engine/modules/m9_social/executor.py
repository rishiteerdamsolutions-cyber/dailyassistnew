...
class SocialFlowExecutor:
    ...
    def _execute_step(self, step: Step, params: dict, flow: SocialFlow) -> bool:
        ...
        if step.action == ActionType.NAVIGATE:
            ...
            try:
                # Re-activate just to be 100% sure Chrome has focus before sending keystrokes
        ...
        if step.action == ActionType.OS_OPEN:
            ...
            try:
                with open("/Users/nandagiriaditya/GEMINI/ARTIFICIALHUMANAGENT/executor_debug.log", "a") as f:
                    f.write(f"\n--- OS_OPEN ---\n")
                    f.write(f"step.file_key: {step.file_key}\n")
                    f.write(f"media_path resolved: '{media_path}'\n")
                    f.write(f"params keys: {list(params.keys())}\n")
            except Exception:
                pass
            ...
            if media_path:
                try:
                    with open("/Users/nandagiriaditya/GEMINI/ARTIFICIALHUMANAGENT/executor_debug.log", "a") as f:
                        f.write("OS_OPEN: starting hotkeys\n")
                    ...
                    try:
                        ...
                        with open("/Users/nandagiriaditya/GEMINI/ARTIFICIALHUMANAGENT/executor_debug.log", "a") as f:
                            f.write("OS_OPEN: pyperclip copy successful, pasting now\n")
                            
                        pyautogui.hotkey('command', 'v')
                        time.sleep(0.5)
                    except ImportError:
                        with open("/Users/nandagiriaditya/GEMINI/ARTIFICIALHUMANAGENT/executor_debug.log", "a") as f:
                            f.write("OS_OPEN: pyperclip missing! Falling back to typewrite.\n")
                    ...
                    with open("/Users/nandagiriaditya/GEMINI/ARTIFICIALHUMANAGENT/executor_debug.log", "a") as f:
                        f.write("OS_OPEN: Cmd+Shift+G flow COMPLETED. Returning True.\n")
                    return True
                except Exception as e:
                    with open("/Users/nandagiriaditya/GEMINI/ARTIFICIALHUMANAGENT/executor_debug.log", "a") as f:
